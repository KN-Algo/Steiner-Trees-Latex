...
% \geometry{margin=2.5cm} % Ustawienia marginesów

% Zmienne na ścieżki do logo (wstaw swoje ścieżki do logo)
\newcommand{\universitylogo}{logo_politechniki.png} % Logo Politechniki
\newcommand{\clublogo}{logo_kola.png} % Logo Koła

% Enumerate zmodyfikowe o "Step" przed każdym numerkiem
...
% Biblioteka do rysowania m.in. grafów
\usepackage{tikz-network}

% % Bardziej współczesna wersja "Subfigure"
% \usepackage{subfig}
